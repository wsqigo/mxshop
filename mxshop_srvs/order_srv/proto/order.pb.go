...
type OrderItemResponse struct {
	...
	GoodsName  string  `protobuf:"bytes,4,opt,name=goodsName,proto3" json:"goodsName,omitempty"`
	GoodsImage string  `protobuf:"bytes,5,opt,name=goodsImage,proto3" json:"goodsImage,omitempty"`
	GoodsPrice float64 `protobuf:"fixed64,6,opt,name=goodsPrice,proto3" json:"goodsPrice,omitempty"`
	Nums       int32   `protobuf:"varint,7,opt,name=nums,proto3" json:"nums,omitempty"`
}
...
func (x *OrderItemResponse) GetGoodsPrice() float64 {
	if x != nil {
		return x.GoodsPrice
	}
	return 0
...
type OrderInfoDetailResponse struct {
	...
	GoodsItems []*OrderItemResponse `protobuf:"bytes,2,rep,name=goodsItems,proto3" json:"goodsItems,omitempty"`
}
...
func (x *OrderInfoDetailResponse) GetGoodsItems() []*OrderItemResponse {
	if x != nil {
		return x.GoodsItems
	}
	return nil
...
var file_order_proto_rawDesc = []byte{
	...
	0x06, 0x20, 0x01, 0x28, 0x01, 0x52, 0x0a, 0x67, 0x6f, 0x6f, 0x64, 0x73, 0x50, 0x72, 0x69, 0x63,
	0x65, 0x12, 0x12, 0x0a, 0x04, 0x6e, 0x75, 0x6d, 0x73, 0x18, 0x07, 0x20, 0x01, 0x28, 0x05, 0x52,
	0x04, 0x6e, 0x75, 0x6d, 0x73, 0x22, 0x7f, 0x0a, 0x17, 0x4f, 0x72, 0x64, 0x65, 0x72, 0x49, 0x6e,
	...
	0x66, 0x6f, 0x12, 0x32, 0x0a, 0x0a, 0x67, 0x6f, 0x6f, 0x64, 0x73, 0x49, 0x74, 0x65, 0x6d, 0x73,
	0x18, 0x02, 0x20, 0x03, 0x28, 0x0b, 0x32, 0x12, 0x2e, 0x4f, 0x72, 0x64, 0x65, 0x72, 0x49, 0x74,
	0x65, 0x6d, 0x52, 0x65, 0x73, 0x70, 0x6f, 0x6e, 0x73, 0x65, 0x52, 0x0a, 0x67, 0x6f, 0x6f, 0x64,
	0x73, 0x49, 0x74, 0x65, 0x6d, 0x73, 0x22, 0x64, 0x0a, 0x12, 0x4f, 0x72, 0x64, 0x65, 0x72, 0x46,
	...
	0x73, 0x65, 0x52, 0x04, 0x64, 0x61, 0x74, 0x61, 0x32, 0xd0, 0x03, 0x0a, 0x05, 0x4f, 0x72, 0x64,
	0x65, 0x72, 0x12, 0x33, 0x0a, 0x0f, 0x47, 0x65, 0x74, 0x43, 0x61, 0x72, 0x74, 0x49, 0x74, 0x65,
	...
	0x47, 0x65, 0x74, 0x4f, 0x72, 0x64, 0x65, 0x72, 0x4c, 0x69, 0x73, 0x74, 0x12, 0x13, 0x2e, 0x4f,
	...
	0x70, 0x6f, 0x6e, 0x73, 0x65, 0x12, 0x39, 0x0a, 0x0e, 0x47, 0x65, 0x74, 0x4f, 0x72, 0x64, 0x65,
...
var file_order_proto_depIdxs = []int32{
	...
	8,  // 9: Order.GetOrderList:input_type -> OrderFilterRequest
	3,  // 10: Order.GetOrderDetail:input_type -> OrderRequest
	1,  // 11: Order.UpdateOrderStatus:input_type -> OrderStatus
	10, // 12: Order.GetCartItemList:output_type -> CartItemListResponse
	...
	9,  // 17: Order.GetOrderList:output_type -> OrderListResponse
	7,  // 18: Order.GetOrderDetail:output_type -> OrderInfoDetailResponse
...
type OrderClient interface {
	//购物车
	GetCartItemList(ctx context.Context, in *UserInfo, opts ...grpc.CallOption) (*CartItemListResponse, error)
...
func (c *orderClient) GetCartItemList(ctx context.Context, in *UserInfo, opts ...grpc.CallOption) (*CartItemListResponse, error) {
	out := new(CartItemListResponse)
	err := c.cc.Invoke(ctx, "/Order/GetCartItemList", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
type OrderServer interface {
	//购物车
	GetCartItemList(context.Context, *UserInfo) (*CartItemListResponse, error)
...
func (*UnimplementedOrderServer) GetCartItemList(context.Context, *UserInfo) (*CartItemListResponse, error) {
...
func _Order_GetCartItemList_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(UserInfo)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(OrderServer).GetCartItemList(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/Order/GetCartItemList",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(OrderServer).GetCartItemList(ctx, req.(*UserInfo))
	}
	...
	Methods: []grpc.MethodDesc{
		{
			...
			Handler:    _Order_GetCartItemList_Handler,
		},
		{
