...
func InitConfig() {
	...
	configFileName := fmt.Sprintf("oss_web/%s-prod.yaml", configFilePrefix)
	if isDebug {
		configFileName = fmt.Sprintf("oss_web/%s-stage.yaml", configFilePrefix)
	}
